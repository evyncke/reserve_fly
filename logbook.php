...
<table class="logbookTable">
	...
	<td class="logbookValue">
		<input type="number" size="5" name="engineStartHour" max="<?=$engineStartHour+50?>" value="<?=$engineStartHour?>" onchange="engineTimeChanged(false);"> H
<?php
...
?>
	...
	<td class="logbookValue">
		<input type="number" size="5" name="engineEndHour" max="<?=$engineStartHour+30?>" value="<?=$engineEndHour?>" onchange="engineTimeChanged(false);"> H
<?php
if ($booking['compteur_type'] == 1) 
...
<table class="logbookTable">
	...
	<tr><td class="logbookLabel">Fin:</td><td class="logbookValue">
		<input type="number" size="5" name="flightEndHour" XXXmax="<?=$flightStartHour+30?>" value="<?=$flightEndHour?>" onchange="flightTimeChanged(false);"> H
