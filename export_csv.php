...
exportSQL("SELECT id, jom_id, name, first_name, last_name, email, home_phone, cell_phone, activated, ciel_code, address, zipcode, city, state, country
		FROM $table_person",
	array('id', 'jom_id', 'name', 'first_name', 'last_name', 'email', 'home_phone', 'cell_phone', 'activated', 'ciel_code', 'address', 'zipcode', 'city', 'state', 'country'),
