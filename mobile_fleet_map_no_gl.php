...
<script type='text/javascript' src='js/fleet_map_no_gl.js'></script>
" ;
$body_attributes = "onload=\"init();initFleet($apt_longitude, $apt_latitude, '$mapbox_token', $zoom_level, 'get_tracks.php$latest');\"" ;
